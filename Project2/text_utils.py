"""
Text utility functions used by the AI vs. Human Text Detection models.

The saved scikit-learn pipelines reference this module when they are loaded
with joblib. Because of that, this file must be included with the Streamlit app
in Hugging Face Spaces. Do not rename or remove the classes/functions here
